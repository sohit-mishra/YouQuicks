...
import Navbar from "@/pages/Employee/Component/Navbar";
import Sidebar from "@/pages/Employee/Component/Sidebar";
  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-1 pt-[72px]">
        ...
        <main className="flex-1 md:ml-60 p-4 overflow-auto">
          {" "}
          <Outlet />
        </main>
      </div>
