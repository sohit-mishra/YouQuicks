...
export default function Forgetpassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/auth/admin/forgot-password`, {
        email,
      });
  ...
  return (
    <section className="my-15 flex items-center justify-center bg-gray-100 py-10">
      ...
      >
        <h1 className="text-2xl font-bold text-gray-800 text-center">Admin Forgot Password</h1>
