...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/auth/employee/reset-password`, {
        token:token,
  ...
  return (
    <section className="my-15 flex items-center justify-center bg-gray-100 py-10">
      ...
      >
        <h1 className="text-2xl font-bold text-gray-800 mb-10 text-center">Employee Reset Password</h1>
