...
export default function EmployeeUserList() {
  ...
  const fetchOrders = async () => {
    try {
      const res = await api.get(`${import.meta.env.VITE_API_URL}/api/user/all`);
      ...
      >
        <div className="p-6 overflow-x-auto">
          {loading ? (
            ...
            <p className="text-center text-gray-500">All User not found.</p>
          ) : (
            <>
              <Table>
                <TableHeader>
